...
def ClaimsData_ConfidentialityBreach():
    ...
    """
    claimsCBreach = le.decomposedRisk("Claims data confidentiality breach", lambda foo=1:st.beta.rvs(1,20))
...
def TestRisk():
    ...
    sim.run(iterations = 100000, aggregate = False, plot = True, presentation = True)
    return sim
